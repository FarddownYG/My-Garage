...
const translations = {
  fr: {
    ...
    'settings.customProfilesDesc': 'Profils personnalisés essence/diesel/4x4',
    ...
    'alertSettings.title': "Seuils d'alertes",
    'alertSettings.subtitle': "Personnaliser les seuils d'affichage",
    'alertSettings.back': '← Retour',
    'alertSettings.explanation': "Les alertes d'échéances apparaissent lorsqu'un entretien est à moins de",
    'alertSettings.explanationOr': 'ou',
    'alertSettings.explanationEnd': "de l'échéance, ainsi que pour les échéances dépassées.",
    'alertSettings.mileageThreshold': 'Seuil kilométrique',
    'alertSettings.mileageThresholdDesc': 'Alerte quand il reste moins de X km',
    'alertSettings.dateThreshold': 'Seuil temporel',
    'alertSettings.dateThresholdDesc': 'Alerte quand il reste moins de X mois',
    'alertSettings.default': 'Par défaut',
    'alertSettings.saved': '✓ Enregistré !',
    'alertSettings.month': 'mois',
    'alertSettings.months': 'mois',
    // Maintenance Settings
    'maintSettings.title': "Paramètres d'entretien",
    'maintSettings.subtitle': 'Intervalles par type de motorisation',
    'maintSettings.back': 'Retour',
    'maintSettings.customProfiles': 'Entretiens Perso',
    'maintSettings.new': 'Nouveau',
    'maintSettings.gasoline': 'Essence',
    'maintSettings.diesel': 'Diesel',
    'maintSettings.addType': "Ajouter un type d'entretien",
    'maintSettings.name': 'Nom *',
    'maintSettings.icon': 'Icône',
    'maintSettings.engine': 'Motorisation',
    'maintSettings.engineBoth': 'Essence + Diesel',
    'maintSettings.driveType': 'Type de traction',
    'maintSettings.driveBoth': '4x2 + 4x4',
    'maintSettings.intervalMonths': 'Intervalle (mois)',
    'maintSettings.intervalKm': 'Intervalle (km)',
    'maintSettings.cancel': 'Annuler',
    'maintSettings.save': 'Enregistrer',
    'maintSettings.add': 'Ajouter',
    'maintSettings.confirmDelete': "Supprimer ce type d'entretien ?",
    'maintSettings.noInterval': 'Aucun intervalle défini',
    'maintSettings.engineInfo': "Ces intervalles s'appliqueront automatiquement lors de l'ajout d'un entretien.",
    'maintSettings.engineGasoline': 'Motorisation essence',
    'maintSettings.engineDiesel': 'Motorisation diesel',
    // Alerts
  ...
  en: {
    ...
    'settings.customProfilesDesc': 'Custom profiles gasoline/diesel/4x4',
    'settings.data': 'DATA',
    ...
    // Alert Threshold Settings
    'alertSettings.title': "Alert thresholds",
    'alertSettings.subtitle': "Customize display thresholds",
    'alertSettings.back': '← Back',
    'alertSettings.explanation': "Deadline alerts appear when a maintenance is less than",
    'alertSettings.explanationOr': 'or',
    'alertSettings.explanationEnd': "before the deadline, as well as for overdue deadlines.",
    'alertSettings.mileageThreshold': 'Mileage threshold',
    'alertSettings.mileageThresholdDesc': 'Alert when less than X km remain',
    'alertSettings.dateThreshold': 'Time threshold',
    'alertSettings.dateThresholdDesc': 'Alert when less than X months remain',
    'alertSettings.default': 'Default',
    'alertSettings.saved': '✓ Saved !',
    'alertSettings.month': 'month',
    'alertSettings.months': 'months',
    // Maintenance Settings
    'maintSettings.title': "Maintenance settings",
    'maintSettings.subtitle': 'Intervals by engine type',
    'maintSettings.back': 'Back',
    'maintSettings.customProfiles': 'Custom Maint',
    'maintSettings.new': 'New',
    'maintSettings.gasoline': 'Gasoline',
    'maintSettings.diesel': 'Diesel',
    'maintSettings.addType': "Add a maintenance type",
    'maintSettings.name': 'Name *',
    'maintSettings.icon': 'Icon',
    'maintSettings.engine': 'Engine',
    'maintSettings.engineBoth': 'Gasoline + Diesel',
    'maintSettings.driveType': 'Drive Type',
    'maintSettings.driveBoth': '4x2 + 4x4',
    'maintSettings.intervalMonths': 'Interval (months)',
    'maintSettings.intervalKm': 'Interval (km)',
    'maintSettings.cancel': 'Cancel',
    'maintSettings.save': 'Save',
    'maintSettings.add': 'Add',
    'maintSettings.confirmDelete': "Delete this maintenance type ?",
    'maintSettings.noInterval': 'No interval defined',
    'maintSettings.engineInfo': "These intervals will be automatically applied when adding a maintenance.",
    'maintSettings.engineGasoline': 'Gasoline engine',
    'maintSettings.engineDiesel': 'Diesel engine',
    // Alerts
