...
- ✅ Ajouter **fichiers** (photos, PDF, DOC, etc.) (📄)
- ✅ **Consulter** :
...
Télécharger :
  → Bouton 💾 vert → Sauvegarde sur l'appareil
...
Note: Le bouton "Fichiers" accepte photos ET documents
      Le bouton 💾 télécharge le fichier sur l'appareil
```
...
5. Cliquez sur 💾 → ✅ Télécharge le fichier
6. Cliquez sur 🔗 → ✅ Ouvre dans nouvelle page
